import { invokeAgent } from "@/lib/agents/quant-expert";
...
export async function POST(request: NextRequest) {
  try {
    console.log("[Quant Expert API] Handling post request...");
    ...
    console.error(
      `[Quant Expert API] Failed to handle post request: ${getErrorString(error)}`,
    );
