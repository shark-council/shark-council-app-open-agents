          ...
          <CardContent>
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-row gap-2">
                ...
                <p>{props.debate.uniswapTrade.chain}</p>
              </div>
              {/* Token */}
              ...
              <div className="flex flex-row gap-2">
                <p className="text-muted-foreground">Date:</p>
                <p>
                  {props.debate.uniswapTrade?.exit?.date.toLocaleString() ||
                    "NA"}
                </p>
              </div>
              {/* Exit price */}
              ...
              <div className="flex flex-row gap-2">
                ...
                {props.debate.uniswapTrade?.exit ? (
                  <Button variant="link" className="h-auto p-0" asChild>
                    ...
                    >
                      {formatHash(
                        props.debate.uniswapTrade.exit.transactionHash,
                      )}
                    </Link>
                  </Button>
                ) : (
